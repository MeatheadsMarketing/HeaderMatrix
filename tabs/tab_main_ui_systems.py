...
st.title("Main Ui Systems Schema")

st.markdown("This tab governs the `Main Ui Systems` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_main_ui_systems.csv"
output_path = f"data/tab_main_ui_systems_entries.csv"
