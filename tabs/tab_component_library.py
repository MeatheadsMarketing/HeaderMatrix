...
st.title("Component Library Schema")

st.markdown("This tab governs the `Component Library` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_component_library.csv"
output_path = f"data/tab_component_library_entries.csv"
