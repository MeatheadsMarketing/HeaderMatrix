...
st.title("Module Schema")

st.markdown("This tab governs the `Module` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_tab_module.csv"
output_path = f"data/tab_tab_module_entries.csv"
