...
st.title("Chain Logic Schema")

st.markdown("This tab governs the `Chain Logic` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_chain_logic.csv"
output_path = f"data/tab_chain_logic_entries.csv"
