...
st.title("Assistant Registry Schema")

st.markdown("This tab governs the `Assistant Registry` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_assistant_registry.csv"
output_path = f"data/tab_assistant_registry_entries.csv"
