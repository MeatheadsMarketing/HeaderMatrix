...
st.title("Deployment Tools Schema")

st.markdown("This tab governs the `Deployment Tools` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_deployment_tools.csv"
output_path = f"data/tab_deployment_tools_entries.csv"
