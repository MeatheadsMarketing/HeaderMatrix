...
st.title("Monetization Layer Schema")

st.markdown("This tab governs the `Monetization Layer` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_monetization_layer.csv"
output_path = f"data/tab_monetization_layer_entries.csv"
