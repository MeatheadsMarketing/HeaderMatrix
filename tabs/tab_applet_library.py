...
st.title("Applet Library Schema")

st.markdown("This tab governs the `Applet Library` layer. Below is the schema structure used to define this system layer.")

schema_path = f"schemas/tab_applet_library.csv"
output_path = f"data/tab_applet_library_entries.csv"
